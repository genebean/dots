# Generated by Powerlevel10k configuration wizard on 2021-05-22 at 01:03 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    ranger                  # ranger shell (https://gitccccccucjdgjkrkdkvebrcrljhkiuvckjjkkkulnuebkhub.com/ranger/ranger)
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%093F╔═'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%093F╠═'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%093F╚ᐅ'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=053
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=186
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=093
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=186
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=093
  ...
  # show a coffee cup in the prompt
  function prompt_coffee() {
    p10k segment -i '☕️'
  }

  function instant_prompt_coffee() {
    prompt_coffee
  }

  # OS identifier color.
  typeset -g POWERLEVEL9K_COFFEE_FOREGROUND=186
  typeset -g POWERLEVEL9K_COFFEE_BACKGROUND=093
